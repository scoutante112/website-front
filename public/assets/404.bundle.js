"use strict";
(globalThis["__LOADABLE_LOADED_CHUNKS__"] = globalThis["__LOADABLE_LOADED_CHUNKS__"] || []).push([[404],{
...
function OrdersCallback() {
  ...
  return /*#__PURE__*/react.createElement(react.Fragment, null, /*#__PURE__*/react.createElement("section", {
    ...
    className: `3xl mb-2 ${data.data.order.status === "complete" ? "text-green-500" : data.data.order.status === "expired" ? "opacity-80" : "text-orange-500"}`
  }, data.data.order.status === "complete" ? "Completed" : data.data.order.status === "expired" ? "Expired" : "Pending")), /*#__PURE__*/react.createElement("div", null, /*#__PURE__*/react.createElement("div", {
    ...
    return /*#__PURE__*/react.createElement("tr", {
      ...
      src: `https://cdn.bagou450.com/assets/img/addons/${item.id}`,
      className: 'h-16 w-16'
    }), /*#__PURE__*/react.createElement("div", {
      className: 'my-auto'
  ...
  }, 0).toFixed(2), "\u20AC")), /*#__PURE__*/react.createElement("td", null, /*#__PURE__*/react.createElement("button", {
    className: 'btn btn-outline btn-primary outline-0',
    onClick: function () {
      return downloadProduct();
    }
  }, "Download product", data.data.order.products.length > 1 ? 's' : '')))))), data.data.order.status === "incomplete" && /*#__PURE__*/react.createElement("div", {
