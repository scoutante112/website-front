"use strict";
(globalThis["webpackChunknewwebsite"] = globalThis["webpackChunknewwebsite"] || []).push([[153,229],{
...
function AccountOrderContainer() {
  ...
  const {
    ...
    error,
    isLoading
  } = (0,dist/* default */.ZP)(`${config/* config */.v.privateapilink}/orders`, http/* fetcher */._i);
  if (!data || error || isLoading) {
  ...
  return /*#__PURE__*/react.createElement(react.Fragment, null, /*#__PURE__*/react.createElement(NavBarAccount/* default */.Z, {
    ...
    className: "table w-full max-w-7xl mx-auto border-neutral-content dark:border-neutral border-2"
  }, /*#__PURE__*/react.createElement("thead", null, /*#__PURE__*/react.createElement("tr", {
    className: "w-full"
  }, /*#__PURE__*/react.createElement("th", {
    className: 'hidden xl:block'
  }, "Id"), /*#__PURE__*/react.createElement("th", null, "Product"), /*#__PURE__*/react.createElement("th", {
    className: 'hidden xl:block'
  }, "Status"), /*#__PURE__*/react.createElement("th", null, "Price"), /*#__PURE__*/react.createElement("th", {
    className: 'hidden xl:block'
  }, "Transaction Id"), /*#__PURE__*/react.createElement("th", null))), /*#__PURE__*/react.createElement("tbody", null, data.data.orders.map(function (order, key) {
    return /*#__PURE__*/react.createElement("tr", {
      ...
      className: `hidden xl:table-cell ${order['status'] === 'incomplete' ? 'text-red-500' : order['status'] === 'expired' ? 'text-white' : order['status'] === 'complete' ? 'text-green-500' : ''}`
      ...
      disabled: loading,
      className: "btn btn-secondary btn-outline border-0 my-4 lg:mx-4 lg:my-0 xl:my-4 xl:mx-0",
      onClick: function () {
