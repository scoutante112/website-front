"use strict";
(self["webpackChunknewwebsite"] = self["webpackChunknewwebsite"] || []).push([[517],{
...
/* harmony export */   "default": function() { return /* binding */ AccountLinkOauthCallback; }
/* harmony export */ });
...
/* harmony import */ var _AccountContainer__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(7989);
...
function AccountLinkOauthCallback() {
  ...
  var _useSWR = (0,swr__WEBPACK_IMPORTED_MODULE_1__/* ["default"] */ .ZP)("".concat(_config_config__WEBPACK_IMPORTED_MODULE_7__/* .config */ .v.privateapilink, "/auth/isLogged?infos=true"), _api_http__WEBPACK_IMPORTED_MODULE_2__/* .fetcher */ ._i),
    mutate = _useSWR.mutate;
  var fetchUrl = "".concat(_config_config__WEBPACK_IMPORTED_MODULE_7__/* .config */ .v.privateapilink, "/account/oauthCallback?token=").concat(code, "&type=").concat(type);
        ...
        while (1) switch (_context.prev = _context.next) {
          case 0:
            ...
            return fetch(fetchUrl, {
              headers: {
                ...
                Authorization: "Bearer ".concat(js_cookie__WEBPACK_IMPORTED_MODULE_3__/* ["default"] */ .Z.get('access_token'))
              }
            });
          case 3:
          ...
          case 6:
            ...
            if (data.status === 'success') {
              react_toastify__WEBPACK_IMPORTED_MODULE_4__/* .toast */ .Am.success("You have linked your ".concat(type, " account successfully!"), {
              ...
              message = data.message ? data.message : 'An unexpected error happened.';
              react_toastify__WEBPACK_IMPORTED_MODULE_4__/* .toast */ .Am.error("Error: ".concat(message), {
                position: 'bottom-right',
                autoClose: 5000,
                hideProgressBar: false,
                closeOnClick: true,
