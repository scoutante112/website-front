    ...
    <Link to={`/product/${element.id}`}>
      <div className="card card-compact bg-neutral  hover:bg-base-200 transition-all duration-200 hover:-translate-y-1 h-full shadow-2xl">
        <figure className={'px-4 pt-4'}>
          <LazyLoad><img src={`https://cdn.bagou450.com/assets/img/addons/${element.id}.webp`} alt={element.name + " icon"} className='mt-6 h-52 w-52' width="500" height="500" /></LazyLoad>
        </figure>
