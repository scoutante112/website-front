...
export default function NavBarAccount(tab: tabs) {
    ...
    return (
        <>      <h1
            className='text-4xl my-4 text-center'>Hello, {!data || (error || isLoading) ? 'User' : data.data.name[0].toUpperCase() + data.data.name.slice(1, data.data.name.length)}</h1>
            <section className='mx-auto text-center'>
                <ul className='menu menu-vertical lg:menu-horizontal rounded-box gap-x-2'>
                        ...
                        <>
                            <li>
                                <Link
                                    ...
                                    to={'/account/manage'}>
                                    <svg xmlns='https://www.w3.org/2000/svg' className='h-5 w-5' fill='none'
                        ...
                        <>
                            <li>
                                <Link
                                    ...
                                    to={'/admin/users'}>
                                    <svg className='w-5 h-5' xmlns='https://www.w3.org/2000/svg' fill='none'
                            ...
                            <li>
                                <Link
                                    ...
                                    <svg xmlns='https://www.w3.org/2000/svg' viewBox='0 0 24 24' fill='none'
                                         stroke='currentColor' className='w-5 h-5' strokeWidth='2' strokeLinecap='round'
                    ...
                    {data.data.role ?
                        <>
                            <input type='checkbox' className='toggle toggle-success ml-8 my-auto' checked={admin}
                                   onClick={() => showAdmin(!admin)} /> <p className='mx-2 my-auto'>Show admin</p></>
                        :
                        <></>
                    }
                </ul>
