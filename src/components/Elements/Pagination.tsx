...
const Pagination = ({ totalPages, page, setPage }: {totalPages: number, page: number, setPage: any}) => {
  ...
  return (
    <nav className="flex items-center justify-between border-t border-gray-200 px-4 sm:px-0 mb-4">
      <div className="-mt-px flex w-0 flex-1 mx-2 lg:mx-8 xl:mx-16">
        <button
          ...
          return (
            <button
              ...
              className={`inline-flex items-center border-t-2 ${
                pageNumber === page ? 'border-indigo-500' : 'border-transparent'
              } px-4 pt-4 text-sm font-medium ${
                pageNumber === page ? 'text-indigo-600' : 'text-gray-500 hover:text-gray-700'
              }`}
      ...
      <div className="-mt-px flex w-0 flex-1 justify-end mx-2 lg:mx-8 xl:mx-16">
        <button
