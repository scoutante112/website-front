    ...
    return (
        <div className={dark ? 'bg-bg450-lessdark' : 'bg-white'}>
            ...
            <div className='text-center py-4'>
                ...
                <div>
                    <h1 className={`${dark ? 'text-slate-200' : 'text-black'} text-4xl mb-2`}>
                        Retrieve Licenses
                    </h1>
                    <h2 className={`${dark ? 'text-slate-300' : 'text-black'} text-lg mb-2 font-normal`}>
                        Retrieve your Bagou450 licenses here. This page is for <strong className={'font-bold text-xl'}>non-existent</strong> licenses. If you already have a license, please go to your <NavLink to={'/account/licenses'} className={'text-bg450-logo hover:text-bg450-logohover'}>account space</NavLink>.
                    </h2>
                    <div>
                        ...
                        <div className='lg:border-b lg:border-t lg:border-gray-200 mb-4'>
                            <nav className='mx-auto max-w-7xl px-4 sm:px-6 lg:px-8' aria-label='Progress'>
                                ...
                                >
                                            ...
                                            <div className='group'>
                                                ...
                                                <span className='flex items-center px-6 py-5 text-sm font-medium'>
                                                    ...
                                                    <span className='ml-4 flex min-w-0 flex-col'>
                                                        <span
                                                            className={`${dark && 'text-slate-300'} text-sm font-medium`}>Select the store</span>
                                                    </span>
                                                </span>
                                            </div>
                                        </div>
                                    ...
                                    <li className='relative overflow-hidden lg:flex-1'>
                                        <div className='overflow-hidden border border-gray-200 lg:border-0'>
                                            <div className={selected ? 'group' : 'group'}>
                                                <span
                                                    className='absolute left-0 top-0 h-full w-1 bg-transparent group-hover:bg-gray-200 lg:bottom-0 lg:top-auto lg:h-1 lg:w-full'
                                                    aria-hidden='true' />
                                                <span className='flex items-center px-6 py-5 text-sm font-medium'>
                                                    <span className='flex-shrink-0'>
                                                        <span
                                                            ...
                                                            <span
                                                                className={selected ? 'text-indigo-600' : 'text-gray-500'}>2</span>
                                                        </span>
                                                    </span>
                                                    <span className='ml-4 flex min-w-0 flex-col'>
                                                        <span
                                                            className={`text-sm font-medium ${selected ? 'text-indigo-600' : 'text-gray-500'}`}>Enter your informations</span>
                                                    </span>
                                                </span>
                                            </div>
                                        </div>
                                    ...
                                    <li className='relative overflow-hidden lg:flex-1'>
                                        <div className='overflow-hidden border border-gray-200 lg:border-0'>
                                            <div className={license ? 'group' : 'group'}>
                                                <span
                                                    className='absolute left-0 top-0 h-full w-1 bg-transparent group-hover:bg-gray-200 lg:bottom-0 lg:top-auto lg:h-1 lg:w-full'
                                                    aria-hidden='true' />
                                                <span className='flex items-center px-6 py-5 text-sm font-medium'>
                                                    <span className='flex-shrink-0'>
                                                        <span
                                                            ...
                                                            <span
                                                                className={license ? 'text-indigo-600' : 'text-gray-500'}>3</span>
                                                        </span>
                                                    </span>
                                                    <span className='ml-4 flex min-w-0 flex-col'>
                                                        <span
                                                            className={`text-sm font-medium ${license ? 'text-indigo-600' : 'text-gray-500'}`}>Get your license</span>
                                                    </span>
                                                </span>
                                            </div>
                                        </div>
                        ...
                        <AnimatePresence>  {!selected ? (
                            <motion.div initial={{ opacity: 0 }} transition={{ duration: 0.5 }} animate={{ opacity: 1 }}
                                exit={{ opacity: 0 }}>
                                <p className={`mb-2 mt-2 ${dark ? 'text-slate-200' : 'text-white'} text-2xl`}>Where you bought it?:</p>
                        ...
                        <AnimatePresence>
                            {boughtlocation === 'bgshop' && selected ? (
                                ...
                                <motion.div initial={{ opacity: 0 }} transition={{ duration: 0.5, delay: 1 }}
                                    animate={{ opacity: 1 }}
                                    exit={{ opacity: 0 }} className={'text-black'}>
                                    <p className={dark ? 'text-slate-200' : 'text-black'}>If you have purchased the
                                        product from the Bagou450 store, you can easily access your license by logging
                                        into your account.</p>
                                </motion.div>
                                ...
                                <motion.div initial={{ opacity: 0 }} transition={{ duration: 0.5, delay: 1 }}
                                    ...
                                    <p className={`${dark ? 'text-slate-200' : 'text-black'} mb-2 mt-2 text-2xl`}>Enter
                                            your email:</p>
                                ...
                                : boughtlocation === 'pm' && selected ? (
                                    ...
                                    <motion.div initial={{ opacity: 0 }} transition={{ duration: 0.5, delay: 1 }}
                                        ...
                                        <div className='text-center mx-auto'>
                                            <h4 className={`${dark ? 'text-slate-200' : 'text-black'} text-2xl`}>How to
                                                find your UserId?</h4>
                                            <p className={`${dark ? 'text-slate-300' : 'text-gray-700'} opacity-90`}>For
                                                find your user id go on <a href={'https://builtbybits.com'}
                                                target='_blank'
                                                rel='noreferrer'>BuiltByBits</a> and click on
                                                your account.
                                            <br /> After click on your username for go on your account page.
                                            <br />When you are on the account page check the url you normally see at
                                                end something like
                                                &ldquo;bagou450.<span className='font-bold'>187451</span>&ldquo;.
                                            <br />You need to take the number after your username.
                                            <br />Here with this exemple the id is 187451! If you need more help see
                                                the screenshot. </p>
            ...
            <div className='mx-auto text-center '>
                <h2 className={`${dark ? 'text-slate-200' : 'text-black'} text-4xl mb-4 font-bold`}>Some statistics</h2>
                <div className='py-12 sm:py-24'>
                    <div className='mx-auto max-w-7xl px-6 lg:px-8'>
                        <dl className='grid grid-cols-1 gap-x-8 gap-y-16 text-center lg:grid-cols-3'>
                            ...
                            <div className='mx-auto flex max-w-xs flex-col gap-y-4'>
                                <dt className={`${dark ? 'text-slate-200' : 'text-gray-600'} leading-7 `}>Daily usage
                                </dt>
                                <dd className={`${dark ? 'text-slate-300' : 'text-gray-900'} order-first text-3xl font-semibold tracking-tight sm:text-5xl`}>
                                    +60 000
                                </dd>
