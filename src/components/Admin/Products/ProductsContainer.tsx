...
export default function ProductsContainer() {
    ...
    const {
        ...
        error,
        isLoading,
    } = useSWR<ProductResponse>(`${config.privateapilink}/admin/products?page=${page}&perpage=${perpage}&search=${search}`, fetcher);
            ...
            <div className='-mx-4 mt-2 ring-1 ring-gray-300 sm:mx-0 sm:rounded-lg'>
                <table className='min-w-full divide-y divide-gray-300 text-black'>
                    ...
                    <tr>
                        ...
                        <th scope='col'
                            className='py-3.5 px-3 text-left text-sm font-semibold text-gray-900  table-cell'>Actions
                        </th>
...
function ProductRow({ product, page, perpage, search }: {
    product: Product,
    page: number;
    perpage: number,
    search: string
