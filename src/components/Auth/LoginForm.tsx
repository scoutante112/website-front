...
export default function LoginForm({ setIsRegistred, setEmail }: {
                    ...
                    <div>
                        <div className='relative mt-10'>
                            ...
                            <div className='relative flex justify-center text-sm font-medium leading-6'>
                                <span
                                    className={`${dark ? 'bg-bg450-lessdark text-slate-300' : 'bg-white text-gray-700'} px-6 `}>Or continue with</span>
                            </div>
                        </div>
